...
<?php $product_data = get_product_data($con, '2'); ?>
...
<?php
if ($_POST['choix-multiple'] == 3){
    echo '<select class="choix-multiple" name="choix-multiple">';
    echo '  <option value="3" selected>Apex</option>';
    echo '  <option value="4">EcoTech</option>';
    echo '</select>';
}
else{
    echo '<select class="choix-multiple" name="choix-multiple">';
    echo '  <option value="3">Apex</option>';
    echo '  <option value="4" selected>EcoTech</option>';
    echo '</select>';
}
?>
